...
export const Footer = () => {
  ...
  const socialLinks = [
    ...
    { icon: <Github size={18} />, href: "https://github.com/Realfencer", label: "GitHub" },
  ];
  ...
  const contactInfo = [
    { icon: <Mail size={16} />, text: "matthewsliger0302@gmail.com", href: "mailto:matthewsliger0302@gmail.com.com" },
    { icon: <Phone size={16} />, text: "+1 2543409272", href: "tel:+919315145594" },
  ];
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">SLIGER</h3>
          ...
          >
            <div>
              <p>© {currentYear} Sliger. All rights reserved.</p>
            </div>
