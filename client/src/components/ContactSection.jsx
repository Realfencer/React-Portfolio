  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Please try again or email me directly at matthewsliger0302@gmail.com",
        variant: "destructive"
      });
    } finally {
              ...
              <div className="flex gap-2 sm:gap-3">
                {[
                  ...
                  },
                  {
                    icon: Github,
                    label: "GitHub",
                    url: "https://github.com/Realfencer",
                  },
                  {
                    icon: Instagram,
                    label: "Instagram",
